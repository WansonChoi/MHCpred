...
from ldpred import coord_genotypes_WS
...
def main_with_args(args):
    ...
    if action=='coord':
        ...
        coord_genotypes_WS.main(p_dict)
    elif action=='gibbs':
        print("[WS] : Going into Gibbs")
...
if __name__ == '__main__':
    ...
    ### (2020.02.28.)
    # command = "--debug coord " \
    #           "--gf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_58C+NBS_06.hg19.27892021-34892022.CONTROL " \
    #           "--ssf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.TRAIN.assoc.logistic.NoNA.ss " \
    #           "--out /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.TRAIN.assoc.logistic.NoNA.ss.coord " \
    #           "--N 2818 --ssf-format CUSTOM --eff OR --rs SNP --pos BP --pval P --maf 0".split(' ')

    ### (2020.02.28.) BP redefined.
    # command = "--debug coord " \
    #           "--gf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_58C+NBS_06.hg19.27892021-34892022.MICHIGAN_IMP.CONTROL.bmarker " \
    #           "--ssf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.MICHIGAN_IMP.TRAIN.bmarker.assoc.logistic.NoNA.ss " \
    #           "--out /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.MICHIGAN_IMP.TRAIN.bmarker.assoc.logistic.NoNA.ss.coord " \
    #           "--N 2818 --ssf-format CUSTOM --eff OR --rs SNP --pos BP --pval P --maf 0 --max-freq-discrep 1 --skip-coordination".split(' ')

    ### (2020.03.08.) Additional Characters without '--skip-coordination'.
    # command = "--debug coord " \
    #           "--gf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_58C+NBS_06.hg19.27892021-34892022.CONTROL " \
    #           "--ssf /media/sf_VM_Shared/Projects/ldpred/20200309/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.TRAIN.assoc.logistic.NoNA.ss " \
    #           "--out /media/sf_VM_Shared/Projects/ldpred/20200309/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.TRAIN.assoc.logistic.NoNA.coord " \
    #           "--N 2818 --ssf-format CUSTOM --eff OR --rs SNP --pos BP --pval P".split(' ')

    ### (2020.02.28.) BP dup
    # command = "--debug coord " \
    #           "--gf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_58C+NBS_06.hg19.27892021-34892022.MICHIGAN_IMP.CONTROL.bmarker " \
    #           "--ssf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.MICHIGAN_IMP.TRAIN.bmarker.BPdup.assoc.logistic.NoNA.ss " \
    #           "--out /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.MICHIGAN_IMP.TRAIN.bmarker.BPdup.assoc.logistic.NoNA.ss.coord " \
    #           "--N 2818 --ssf-format CUSTOM --eff OR --rs SNP --pos BP --pval P --maf 0 --max-freq-discrep 1 --skip-coordination".split(' ')


    ### (2020.03.18.) Additional Characters (w/o '--skip-coordination', w '--maf 0'). trial 2
    # command = "--debug coord " \
    #           "--gf /media/sf_VM_Shared/Projects/ldpred/20200318_GTtrick/wtccc_filtered_58C+NBS_06.hg19.27892021-34892022.CONTROL.bmarker " \
    #           "--ssf /media/sf_VM_Shared/Projects/ldpred/20200318_GTtrick/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.TRAIN.bmarker.assoc.logistic.NoNA.ss " \
    #           "--out /media/sf_VM_Shared/Projects/ldpred/20200318_GTtrick/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.NoNA.DESKTOP.general_Marker.TRAIN.bmarker.coord " \
    #           "--N 2818 --ssf-format CUSTOM --eff OR --rs SNP --pos BP --pval P --maf 0".split(' ')


    # command = "--debug score " \
    #           "--gf /media/sf_VM_Shared/Projects/ldpred/20200318_GTtrick/wtccc_filtered_58C+RA_06.hg19.27892021-34892022.TEST.bmarker " \
    #           "--rf /media/sf_VM_Shared/Projects/ldpred/20200318_GTtrick/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.NoNA.DESKTOP.general_Marker.TRAIN.bmarker.GIBBS " \
    #           "--out /media/sf_VM_Shared/Projects/ldpred/20200318_GTtrick/wtccc_filtered_58C+RA_06.hg19.27892021-34892022.DESKTOP.general_Marker.TEST.bmarker.SCORE " \
    #           "--pf /media/sf_VM_Shared/Projects/ldpred/20200318_GTtrick/wtccc_filtered_58C+RA_06.hg19.27892021-34892022.TEST.bmarker.phe " \
    #           "--pf-format LSTANDARD".split(' ')





    ### (2020.03.20.) Finding memory error in Gibbs step.
    # command = "--debug gibbs " \
    #           "--cf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.MICHIGAN_IMP.TRAIN.bmarker.assoc.logistic.NoNA.ss.MAF_0.SKIP_COORD.coord " \
    #           "--ldr 85538 " \
    #           "--ldf /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.MICHIGAN_IMP.TRAIN.bmarker.assoc.logistic.NoNA.ss.FIND_Mem_error.LD " \
    #           "--out /media/sf_VM_Shared/Projects/ldpred/wtccc_filtered_NBS+RA_06.hg19.27892021-34892022.MICHIGAN_IMP.TRAIN.bmarker.assoc.logistic.NoNA.ss.FIND_Mem_error.GIBBS " \
    #           "--N 2818".split(' ')
