...
def filter_coord_data(cd, filter_mask):
    data_keys = ['raw_snps_ref', 'snp_stds_ref', 'snp_means_ref', 'freqs_ref' ,'ps', 'ns', 'positions', 'nts', 'sids','betas','log_odds'] # modified (2020.02.21.)
...
def coordinate_datasets(reference_genotype_file, hdf5_file, summary_dict,
    ...
    for chrom in chromosomes:
        ...
        num_ambig_nts = 0
        num_maf_filtered_snps = 0 ### modified by WS (2020.02.28.)
